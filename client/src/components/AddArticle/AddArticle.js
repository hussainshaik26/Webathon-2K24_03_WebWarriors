...
function Addarticle() {
    ...
    const tagOptions = {
        ...
        romance: ['Contemporary Romance', 'Historical Romance', 'Paranormal Romance', 'Erotic Romance'],
        abstract: ['Abstract Expressionism', 'Cubism', 'Surrealism', 'Minimalism'],
        tragedy: ['Shakespearean Tragedy', 'Greek Tragedy', 'Modern Tragedy', 'Domestic Tragedy'],
        ...
        study: ['Study Techniques', 'Exam Preparation', 'Effective Learning', 'Time Management'],
    ...
    // Form submission handler
const onSubmit = (data) => {
    // Filter out false values from the tags array
    const filteredTags = data.tags.filter(tag => tag !== false);
    
    // Update the data.tags array with filteredTags
